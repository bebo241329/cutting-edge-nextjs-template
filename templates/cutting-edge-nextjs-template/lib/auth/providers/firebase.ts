...
async function loadFirebaseAuth() {
  const firebaseClientModulePath = "@/lib/firebase" + "/client";
  const { getFirebaseAuth } = await import(firebaseClientModulePath);
...
async function loadFirebaseFirestore() {
  const firebaseClientModulePath = "@/lib/firebase" + "/client";
  const { getFirebaseFirestore } = await import(firebaseClientModulePath);
